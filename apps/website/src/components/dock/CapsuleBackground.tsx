...
// White capsule as a horizontal 9-slice: fixed caps + a stretchable middle. Left cap; right is mirrored.
const CAP_PATH =
  ...
  return (
    <div
      ...
      style={{
        ...
        display: "flex",
        alignItems: "stretch",
        // Full-pill radius so the box-shadow hugs the capsule.
        borderRadius: "9999px",
        boxShadow: "0 6px 14px -7px color(display-p3 0.451 0.3412 0.2902 / 0.30)",
      }}
    >
      <Cap />
      {/* -1px overlap hides the cap/middle seam. */}
