// device-radius: device-aware iPhone screen corner radius, inferred from UA + iOS version, viewport,
// and DPR (Apple never exposes it). Ambiguous viewports return the lower radius at confidence "low".
// Radii are CSS px, which equal points on iOS. Zero dependencies; see README.md.
